      ...
      <section className="py-20 bg-midnight-900 border-t border-white/5 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contact" className="px-8 py-4 bg-gold-gradient text-midnight-950 font-bold rounded-xl uppercase tracking-wide glow-gold hover:-translate-y-1 transition-all">
              Book a Visit (₹299)
            </Link>
